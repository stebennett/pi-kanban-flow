...
test("parent attestation normalizes roots and secrets and renders deterministic destination", () => {
  ...
  assert.deepEqual(attestation.finding_ids, []);
