...
| Closed-unmerged design PR retries; ambiguous PR state blocks | Retained/Changed | Closed design PR may return to `backlog` within budget; ambiguity blocks. Recovery uses markers rather than URL fields alone. |
